...
version_file = 'sampling_argmax/version.py'
...
def get_hash():
    if os.path.exists('.git'):
        ...
        try:
            from sampling_argmax.version import __version__
...
if __name__ == '__main__':
    ...
    setup(
        ...
        version=get_version(),
        description='Code for Sampling-Argmax',
        long_description=readme(),
        keywords='computer vision, sampling-argmax',
