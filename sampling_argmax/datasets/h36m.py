...
from sampling_argmax.utils.pose_utils import (cam2pixel, pixel2cam,
...
class H36m(data.Dataset):
    ...
    def evaluate(self, preds, result_dir):
        ...
        pa_error = np.zeros((sample_num, self.num_joints - 1))  # joint error
        ...
        eval_summary = f'Protocol {self.protocol} error ({metric}) >> tot: {tot_err:2f}, x: {tot_err_x:2f}, y: {tot_err_y:.2f}, z: {tot_err_z:2f}\n PA MPJPE: {tot_pa_error}\n'
